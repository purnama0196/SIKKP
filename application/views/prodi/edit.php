        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="box">
              ...
              <div class="box-body">
                <!-- form start -->
                <form class="form-horizontal" method="post" action="<?php echo base_url('prodi/processEdit');?>">
                  <input type="hidden" class="form-control" id="id"
                        name="id" value="<?php echo $prodi->id_prodi;?>">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="nik" class="col-sm-2 control-label">Prodi</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="prodi" placeholder="prodi"
                        name="prodi" value="<?php echo $prodi->prodi;?>" required>
                      </div>
                    </div>
                    <div class="form-group">
                          ...
                          <?php 
                            if(!empty($kaprodi)){
                              foreach ($kaprodi as $key => $value) {
                                if($value["nama_dosen"] == $prodi->kaprodi){
                          ?>
                            <option value="<?php echo $value['nama_dosen']?>" selected><?php echo $value["nama_dosen"]?></option>
                          <?php }else{?>
                  ...
                  <div class="box-footer">
                    ...
                    <a href="<?php echo base_url('prodi/index')?>">
